...
namespace offsets {
    const uintptr_t EnableLoadModule = 0x7811c08; // old: 0x67B90E8
    ...
    namespace userdata {
        constexpr uint64_t identity = 0x30;
        constexpr uint64_t capabilities = 0x50;
    }
    namespace lua_State {
        constexpr uint64_t userdata = 0x8;
    }
}